...
LoginEntity $LoginEntityFromJson(Map<String, dynamic> json) {
  ...
  final LoginAccount? account = jsonConvert.convert<LoginAccount>(
    json['account'],
  );
  if (account != null) {
  ...
  final LoginProfile? profile = jsonConvert.convert<LoginProfile>(
    json['profile'],
  );
  if (profile != null) {
    loginEntity.profile = profile;
  }
  final List<LoginBindings>? bindings = (json['bindings'] as List<dynamic>?)
      ?.map((e) => jsonConvert.convert<LoginBindings>(e) as LoginBindings)
      .toList();
  if (bindings != null) {
...
LoginProfile $LoginProfileFromJson(Map<String, dynamic> json) {
  ...
  final LoginProfileExperts? experts = jsonConvert.convert<LoginProfileExperts>(
    json['experts'],
  );
  if (experts != null) {
...
LoginBindings $LoginBindingsFromJson(Map<String, dynamic> json) {
  ...
  final String? tokenJsonStr = jsonConvert.convert<String>(
    json['tokenJsonStr'],
  );
