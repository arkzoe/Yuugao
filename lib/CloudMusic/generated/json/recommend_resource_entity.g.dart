...
RecommendResourceEntity $RecommendResourceEntityFromJson(
  ...
  final RecommendResourceEntity recommendResourceEntity =
  ...
  final List<RecommendResourceRecommend>? recommend =
      (json['recommend'] as List<dynamic>?)
          ?.map(
            (e) =>
                jsonConvert.convert<RecommendResourceRecommend>(e)
                    as RecommendResourceRecommend,
          )
          .toList();
  if (recommend != null) {
...
RecommendResourceRecommend $RecommendResourceRecommendFromJson(
  ...
  final RecommendResourceRecommend recommendResourceRecommend =
  ...
  final RecommendResourceRecommendCreator? creator = jsonConvert
      .convert<RecommendResourceRecommendCreator>(json['creator']);
  if (creator != null) {
...
RecommendResourceRecommendCreator $RecommendResourceRecommendCreatorFromJson(
  ...
  final RecommendResourceRecommendCreator recommendResourceRecommendCreator =
  ...
  final List<String>? expertTags = (json['expertTags'] as List<dynamic>?)
...
extension RecommendResourceRecommendCreatorExtension
