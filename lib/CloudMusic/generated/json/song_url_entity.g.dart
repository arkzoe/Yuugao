...
SongUrlEntity $SongUrlEntityFromJson(Map<String, dynamic> json) {
  ...
  final List<SongUrlData>? data = (json['data'] as List<dynamic>?)
      ?.map((e) => jsonConvert.convert<SongUrlData>(e) as SongUrlData)
      .toList();
  if (data != null) {
...
SongUrlData $SongUrlDataFromJson(Map<String, dynamic> json) {
  ...
  final SongUrlDataFreeTrialPrivilege? freeTrialPrivilege = jsonConvert
      .convert<SongUrlDataFreeTrialPrivilege>(json['freeTrialPrivilege']);
...
SongUrlDataFreeTrialPrivilege $SongUrlDataFreeTrialPrivilegeFromJson(
  ...
  final SongUrlDataFreeTrialPrivilege songUrlDataFreeTrialPrivilege =
...
extension SongUrlDataFreeTrialPrivilegeExtension
    on SongUrlDataFreeTrialPrivilege {
...
SongUrlDataFreeTimeTrialPrivilege $SongUrlDataFreeTimeTrialPrivilegeFromJson(
  ...
  final SongUrlDataFreeTimeTrialPrivilege songUrlDataFreeTimeTrialPrivilege =
...
extension SongUrlDataFreeTimeTrialPrivilegeExtension
    on SongUrlDataFreeTimeTrialPrivilege {
