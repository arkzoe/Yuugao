...
NewAlbumEntity $NewAlbumEntityFromJson(Map<String, dynamic> json) {
  ...
  final List<NewAlbumAlbums>? albums = (json['albums'] as List<dynamic>?)
      ?.map((e) => jsonConvert.convert<NewAlbumAlbums>(e) as NewAlbumAlbums)
      .toList();
  if (albums != null) {
...
NewAlbumAlbums $NewAlbumAlbumsFromJson(Map<String, dynamic> json) {
  ...
  final List<NewAlbumAlbumsArtists>? artists =
      (json['artists'] as List<dynamic>?)
          ?.map(
            (e) =>
                jsonConvert.convert<NewAlbumAlbumsArtists>(e)
                    as NewAlbumAlbumsArtists,
          )
          .toList();
  if (artists != null) {
  ...
  final NewAlbumAlbumsArtist? artist = jsonConvert
      .convert<NewAlbumAlbumsArtist>(json['artist']);
  if (artist != null) {
...
NewAlbumAlbumsArtists $NewAlbumAlbumsArtistsFromJson(
...
Map<String, dynamic> $NewAlbumAlbumsArtistsToJson(
  NewAlbumAlbumsArtists entity,
) {
  final Map<String, dynamic> data = <String, dynamic>{};
