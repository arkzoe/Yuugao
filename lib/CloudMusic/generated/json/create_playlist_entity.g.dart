...
CreatePlaylistEntity $CreatePlaylistEntityFromJson(Map<String, dynamic> json) {
  ...
  final CreatePlaylistPlaylist? playlist = jsonConvert
      .convert<CreatePlaylistPlaylist>(json['playlist']);
  if (playlist != null) {
...
CreatePlaylistPlaylist $CreatePlaylistPlaylistFromJson(
  ...
  final CreatePlaylistPlaylist createPlaylistPlaylist =
...
Map<String, dynamic> $CreatePlaylistPlaylistToJson(
  CreatePlaylistPlaylist entity,
) {
  final Map<String, dynamic> data = <String, dynamic>{};
