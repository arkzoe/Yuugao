...
AlbumInfoEntity $AlbumInfoEntityFromJson(Map<String, dynamic> json) {
  ...
  final List<AlbumInfoSongs>? songs = (json['songs'] as List<dynamic>?)
      ?.map((e) => jsonConvert.convert<AlbumInfoSongs>(e) as AlbumInfoSongs)
      .toList();
  if (songs != null) {
  ...
  final AlbumInfoAlbum? album = jsonConvert.convert<AlbumInfoAlbum>(
    json['album'],
  );
  if (album != null) {
...
AlbumInfoSongs $AlbumInfoSongsFromJson(Map<String, dynamic> json) {
  ...
  final List<AlbumInfoSongsAr>? ar = (json['ar'] as List<dynamic>?)
      ?.map((e) => jsonConvert.convert<AlbumInfoSongsAr>(e) as AlbumInfoSongsAr)
      .toList();
  if (ar != null) {
    albumInfoSongs.ar = ar;
  }
  final AlbumInfoSongsAl? al = jsonConvert.convert<AlbumInfoSongsAl>(
    json['al'],
  );
  if (al != null) {
  ...
  final AlbumInfoSongsSq? sq = jsonConvert.convert<AlbumInfoSongsSq>(
    json['sq'],
  );
  if (sq != null) {
  ...
  final AlbumInfoSongsPrivilege? privilege = jsonConvert
      .convert<AlbumInfoSongsPrivilege>(json['privilege']);
  if (privilege != null) {
...
extension AlbumInfoSongsArExtension on AlbumInfoSongsAr {
  AlbumInfoSongsAr copyWith({int? id, String? name, List<String>? tns}) {
    return AlbumInfoSongsAr()
      ..id = id ?? this.id
      ..name = name ?? this.name
      ..tns = tns ?? this.tns;
...
AlbumInfoSongsPrivilege $AlbumInfoSongsPrivilegeFromJson(
  Map<String, dynamic> json,
) {
  final AlbumInfoSongsPrivilege albumInfoSongsPrivilege =
  ...
  final AlbumInfoSongsPrivilegeFreeTrialPrivilege? freeTrialPrivilege =
      jsonConvert.convert<AlbumInfoSongsPrivilegeFreeTrialPrivilege>(
  ...
  final List<AlbumInfoSongsPrivilegeChargeInfoList>? chargeInfoList =
      (json['chargeInfoList'] as List<dynamic>?)
          ?.map(
            (e) =>
                jsonConvert.convert<AlbumInfoSongsPrivilegeChargeInfoList>(e)
                    as AlbumInfoSongsPrivilegeChargeInfoList,
          )
          .toList();
...
Map<String, dynamic> $AlbumInfoSongsPrivilegeToJson(
  AlbumInfoSongsPrivilege entity,
) {
  final Map<String, dynamic> data = <String, dynamic>{};
  data['id'] = entity.id;
  data['fee'] = entity.fee;
...
$AlbumInfoSongsPrivilegeFreeTrialPrivilegeFromJson(Map<String, dynamic> json) {
  final AlbumInfoSongsPrivilegeFreeTrialPrivilege
  albumInfoSongsPrivilegeFreeTrialPrivilege =
      AlbumInfoSongsPrivilegeFreeTrialPrivilege();
  ...
  if (cannotListenReason != null) {
    albumInfoSongsPrivilegeFreeTrialPrivilege.cannotListenReason =
        cannotListenReason;
  }
  ...
  if (freeLimitTagType != null) {
    albumInfoSongsPrivilegeFreeTrialPrivilege.freeLimitTagType =
        freeLimitTagType;
  }
...
extension AlbumInfoSongsPrivilegeFreeTrialPrivilegeExtension
    on AlbumInfoSongsPrivilegeFreeTrialPrivilege {
...
$AlbumInfoSongsPrivilegeChargeInfoListFromJson(Map<String, dynamic> json) {
  final AlbumInfoSongsPrivilegeChargeInfoList
  albumInfoSongsPrivilegeChargeInfoList =
      AlbumInfoSongsPrivilegeChargeInfoList();
...
extension AlbumInfoSongsPrivilegeChargeInfoListExtension
    on AlbumInfoSongsPrivilegeChargeInfoList {
...
AlbumInfoAlbum $AlbumInfoAlbumFromJson(Map<String, dynamic> json) {
  ...
  final List<dynamic>? songs = (json['songs'] as List<dynamic>?)
      ?.map((e) => e)
      .toList();
  if (songs != null) {
  ...
  final List<AlbumInfoAlbumArtists>? artists =
      (json['artists'] as List<dynamic>?)
          ?.map(
            (e) =>
                jsonConvert.convert<AlbumInfoAlbumArtists>(e)
                    as AlbumInfoAlbumArtists,
          )
          .toList();
  if (artists != null) {
  ...
  final AlbumInfoAlbumArtist? artist = jsonConvert
      .convert<AlbumInfoAlbumArtist>(json['artist']);
  if (artist != null) {
  ...
  final AlbumInfoAlbumInfo? info = jsonConvert.convert<AlbumInfoAlbumInfo>(
    json['info'],
  );
  if (info != null) {
...
AlbumInfoAlbumArtists $AlbumInfoAlbumArtistsFromJson(
  Map<String, dynamic> json,
) {
...
Map<String, dynamic> $AlbumInfoAlbumArtistsToJson(
  AlbumInfoAlbumArtists entity,
) {
  final Map<String, dynamic> data = <String, dynamic>{};
...
AlbumInfoAlbumArtist $AlbumInfoAlbumArtistFromJson(Map<String, dynamic> json) {
  ...
  final List<String>? transNames = (json['transNames'] as List<dynamic>?)
      ?.map((e) => jsonConvert.convert<String>(e) as String)
      .toList();
  if (transNames != null) {
...
AlbumInfoAlbumInfo $AlbumInfoAlbumInfoFromJson(Map<String, dynamic> json) {
  ...
  final AlbumInfoAlbumInfoCommentThread? commentThread = jsonConvert
      .convert<AlbumInfoAlbumInfoCommentThread>(json['commentThread']);
...
AlbumInfoAlbumInfoCommentThread $AlbumInfoAlbumInfoCommentThreadFromJson(
  ...
  final AlbumInfoAlbumInfoCommentThread albumInfoAlbumInfoCommentThread =
      AlbumInfoAlbumInfoCommentThread();
  final String? id = jsonConvert.convert<String>(json['id']);
  if (id != null) {
    albumInfoAlbumInfoCommentThread.id = id;
  }
  final AlbumInfoAlbumInfoCommentThreadResourceInfo? resourceInfo = jsonConvert
      .convert<AlbumInfoAlbumInfoCommentThreadResourceInfo>(
        json['resourceInfo'],
      );
...
extension AlbumInfoAlbumInfoCommentThreadExtension
    on AlbumInfoAlbumInfoCommentThread {
...
$AlbumInfoAlbumInfoCommentThreadResourceInfoFromJson(
  Map<String, dynamic> json,
) {
  final AlbumInfoAlbumInfoCommentThreadResourceInfo
  albumInfoAlbumInfoCommentThreadResourceInfo =
      AlbumInfoAlbumInfoCommentThreadResourceInfo();
  final int? id = jsonConvert.convert<int>(json['id']);
  if (id != null) {
...
extension AlbumInfoAlbumInfoCommentThreadResourceInfoExtension
    on AlbumInfoAlbumInfoCommentThreadResourceInfo {
