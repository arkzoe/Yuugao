...
SongDetailEntity $SongDetailEntityFromJson(Map<String, dynamic> json) {
  ...
  final List<SongDetailSongs>? songs = (json['songs'] as List<dynamic>?)
      ?.map((e) => jsonConvert.convert<SongDetailSongs>(e) as SongDetailSongs)
      .toList();
  if (songs != null) {
  ...
  final List<SongDetailPrivileges>? privileges =
      (json['privileges'] as List<dynamic>?)
          ?.map(
            (e) =>
                jsonConvert.convert<SongDetailPrivileges>(e)
                    as SongDetailPrivileges,
          )
          .toList();
  if (privileges != null) {
...
SongDetailSongs $SongDetailSongsFromJson(Map<String, dynamic> json) {
  ...
  final List<SongDetailSongsAr>? ar = (json['ar'] as List<dynamic>?)
      ?.map(
        (e) => jsonConvert.convert<SongDetailSongsAr>(e) as SongDetailSongsAr,
      )
      .toList();
  if (ar != null) {
  ...
  final SongDetailSongsAl? al = jsonConvert.convert<SongDetailSongsAl>(
    json['al'],
  );
  if (al != null) {
  ...
  final SongDetailSongsSq? sq = jsonConvert.convert<SongDetailSongsSq>(
    json['sq'],
  );
  if (sq != null) {
...
SongDetailPrivileges $SongDetailPrivilegesFromJson(Map<String, dynamic> json) {
  ...
  final SongDetailPrivilegesFreeTrialPrivilege? freeTrialPrivilege = jsonConvert
      .convert<SongDetailPrivilegesFreeTrialPrivilege>(
  ...
  final List<SongDetailPrivilegesChargeInfoList>? chargeInfoList =
      (json['chargeInfoList'] as List<dynamic>?)
          ?.map(
            (e) =>
                jsonConvert.convert<SongDetailPrivilegesChargeInfoList>(e)
                    as SongDetailPrivilegesChargeInfoList,
          )
          .toList();
...
$SongDetailPrivilegesFreeTrialPrivilegeFromJson(Map<String, dynamic> json) {
  final SongDetailPrivilegesFreeTrialPrivilege
  songDetailPrivilegesFreeTrialPrivilege =
      SongDetailPrivilegesFreeTrialPrivilege();
  ...
  if (cannotListenReason != null) {
    songDetailPrivilegesFreeTrialPrivilege.cannotListenReason =
        cannotListenReason;
  }
...
extension SongDetailPrivilegesFreeTrialPrivilegeExtension
...
SongDetailPrivilegesChargeInfoList $SongDetailPrivilegesChargeInfoListFromJson(
  ...
  final SongDetailPrivilegesChargeInfoList songDetailPrivilegesChargeInfoList =
...
extension SongDetailPrivilegesChargeInfoListExtension
    on SongDetailPrivilegesChargeInfoList {
