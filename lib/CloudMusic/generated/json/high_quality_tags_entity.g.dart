...
HighQualityTagsEntity $HighQualityTagsEntityFromJson(
  Map<String, dynamic> json,
) {
  final HighQualityTagsEntity highQualityTagsEntity = HighQualityTagsEntity();
  final List<HighQualityTagsTags>? tags = (json['tags'] as List<dynamic>?)
      ?.map(
        (e) =>
            jsonConvert.convert<HighQualityTagsTags>(e) as HighQualityTagsTags,
      )
      .toList();
  if (tags != null) {
...
Map<String, dynamic> $HighQualityTagsEntityToJson(
  HighQualityTagsEntity entity,
) {
...
extension HighQualityTagsEntityExtension on HighQualityTagsEntity {
  HighQualityTagsEntity copyWith({List<HighQualityTagsTags>? tags, int? code}) {
    return HighQualityTagsEntity()
      ..tags = tags ?? this.tags
      ..code = code ?? this.code;
  }
