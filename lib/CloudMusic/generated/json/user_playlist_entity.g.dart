...
UserPlaylistEntity $UserPlaylistEntityFromJson(Map<String, dynamic> json) {
  ...
  final List<UserPlaylistPlaylist>? playlist =
      (json['playlist'] as List<dynamic>?)
          ?.map(
            (e) =>
                jsonConvert.convert<UserPlaylistPlaylist>(e)
                    as UserPlaylistPlaylist,
          )
          .toList();
  if (playlist != null) {
...
UserPlaylistPlaylist $UserPlaylistPlaylistFromJson(Map<String, dynamic> json) {
  ...
  final UserPlaylistPlaylistCreator? creator = jsonConvert
      .convert<UserPlaylistPlaylistCreator>(json['creator']);
  if (creator != null) {
...
UserPlaylistPlaylistCreator $UserPlaylistPlaylistCreatorFromJson(
  ...
  final UserPlaylistPlaylistCreator userPlaylistPlaylistCreator =
