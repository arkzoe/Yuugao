...
import 'package:yuugao/CloudMusic/generated/json/high_quality_tags_entity.g.dart';
import 'dart:convert';
export 'package:yuugao/CloudMusic/generated/json/high_quality_tags_entity.g.dart';
...
class HighQualityTagsEntity {
  ...
  factory HighQualityTagsEntity.fromJson(Map<String, dynamic> json) =>
      $HighQualityTagsEntityFromJson(json);
...
class HighQualityTagsTags {
  ...
  factory HighQualityTagsTags.fromJson(Map<String, dynamic> json) =>
      $HighQualityTagsTagsFromJson(json);
