...
import 'package:yuugao/CloudMusic/generated/json/create_playlist_entity.g.dart';
import 'dart:convert';
export 'package:yuugao/CloudMusic/generated/json/create_playlist_entity.g.dart';
...
class CreatePlaylistEntity {
  ...
  factory CreatePlaylistEntity.fromJson(Map<String, dynamic> json) =>
      $CreatePlaylistEntityFromJson(json);
...
class CreatePlaylistPlaylist {
  ...
  factory CreatePlaylistPlaylist.fromJson(Map<String, dynamic> json) =>
      $CreatePlaylistPlaylistFromJson(json);
