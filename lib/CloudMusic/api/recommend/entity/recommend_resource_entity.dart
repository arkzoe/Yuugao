...
import 'package:yuugao/CloudMusic/generated/json/recommend_resource_entity.g.dart';
import 'dart:convert';
export 'package:yuugao/CloudMusic/generated/json/recommend_resource_entity.g.dart';
...
class RecommendResourceEntity {
  ...
  factory RecommendResourceEntity.fromJson(Map<String, dynamic> json) =>
      $RecommendResourceEntityFromJson(json);
...
class RecommendResourceRecommend {
  ...
  factory RecommendResourceRecommend.fromJson(Map<String, dynamic> json) =>
      $RecommendResourceRecommendFromJson(json);
...
class RecommendResourceRecommendCreator {
  ...
  factory RecommendResourceRecommendCreator.fromJson(
    Map<String, dynamic> json,
  ) => $RecommendResourceRecommendCreatorFromJson(json);

  Map<String, dynamic> toJson() =>
      $RecommendResourceRecommendCreatorToJson(this);
