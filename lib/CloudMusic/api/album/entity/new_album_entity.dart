...
import 'package:yuugao/CloudMusic/generated/json/new_album_entity.g.dart';
import 'dart:convert';
export 'package:yuugao/CloudMusic/generated/json/new_album_entity.g.dart';
...
class NewAlbumEntity {
  ...
  factory NewAlbumEntity.fromJson(Map<String, dynamic> json) =>
      $NewAlbumEntityFromJson(json);
...
class NewAlbumAlbums {
  ...
  factory NewAlbumAlbums.fromJson(Map<String, dynamic> json) =>
      $NewAlbumAlbumsFromJson(json);
...
class NewAlbumAlbumsArtists {
  ...
  factory NewAlbumAlbumsArtists.fromJson(Map<String, dynamic> json) =>
      $NewAlbumAlbumsArtistsFromJson(json);
...
class NewAlbumAlbumsArtist {
  ...
  factory NewAlbumAlbumsArtist.fromJson(Map<String, dynamic> json) =>
      $NewAlbumAlbumsArtistFromJson(json);
