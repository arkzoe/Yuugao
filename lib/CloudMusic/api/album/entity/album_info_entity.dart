...
import 'package:yuugao/CloudMusic/generated/json/album_info_entity.g.dart';
import 'dart:convert';
export 'package:yuugao/CloudMusic/generated/json/album_info_entity.g.dart';
...
class AlbumInfoEntity {
  ...
  factory AlbumInfoEntity.fromJson(Map<String, dynamic> json) =>
      $AlbumInfoEntityFromJson(json);
...
class AlbumInfoSongs {
  ...
  factory AlbumInfoSongs.fromJson(Map<String, dynamic> json) =>
      $AlbumInfoSongsFromJson(json);
...
class AlbumInfoSongsAr {
  ...
  factory AlbumInfoSongsAr.fromJson(Map<String, dynamic> json) =>
      $AlbumInfoSongsArFromJson(json);
...
class AlbumInfoSongsAl {
  ...
  factory AlbumInfoSongsAl.fromJson(Map<String, dynamic> json) =>
      $AlbumInfoSongsAlFromJson(json);
...
class AlbumInfoSongsH {
  ...
  factory AlbumInfoSongsH.fromJson(Map<String, dynamic> json) =>
      $AlbumInfoSongsHFromJson(json);
...
class AlbumInfoSongsSq {
  ...
  factory AlbumInfoSongsSq.fromJson(Map<String, dynamic> json) =>
      $AlbumInfoSongsSqFromJson(json);
...
class AlbumInfoSongsL {
  ...
  factory AlbumInfoSongsL.fromJson(Map<String, dynamic> json) =>
      $AlbumInfoSongsLFromJson(json);
...
class AlbumInfoSongsM {
  ...
  factory AlbumInfoSongsM.fromJson(Map<String, dynamic> json) =>
      $AlbumInfoSongsMFromJson(json);
...
class AlbumInfoSongsPrivilege {
  ...
  factory AlbumInfoSongsPrivilege.fromJson(Map<String, dynamic> json) =>
      $AlbumInfoSongsPrivilegeFromJson(json);
...
class AlbumInfoSongsPrivilegeFreeTrialPrivilege {
  ...
  factory AlbumInfoSongsPrivilegeFreeTrialPrivilege.fromJson(
    Map<String, dynamic> json,
  ) => $AlbumInfoSongsPrivilegeFreeTrialPrivilegeFromJson(json);

  Map<String, dynamic> toJson() =>
      $AlbumInfoSongsPrivilegeFreeTrialPrivilegeToJson(this);
...
class AlbumInfoSongsPrivilegeChargeInfoList {
  ...
  factory AlbumInfoSongsPrivilegeChargeInfoList.fromJson(
    Map<String, dynamic> json,
  ) => $AlbumInfoSongsPrivilegeChargeInfoListFromJson(json);

  Map<String, dynamic> toJson() =>
      $AlbumInfoSongsPrivilegeChargeInfoListToJson(this);
...
class AlbumInfoAlbum {
  ...
  factory AlbumInfoAlbum.fromJson(Map<String, dynamic> json) =>
      $AlbumInfoAlbumFromJson(json);
...
class AlbumInfoAlbumArtists {
  ...
  factory AlbumInfoAlbumArtists.fromJson(Map<String, dynamic> json) =>
      $AlbumInfoAlbumArtistsFromJson(json);
...
class AlbumInfoAlbumArtist {
  ...
  factory AlbumInfoAlbumArtist.fromJson(Map<String, dynamic> json) =>
      $AlbumInfoAlbumArtistFromJson(json);
...
class AlbumInfoAlbumInfo {
  ...
  factory AlbumInfoAlbumInfo.fromJson(Map<String, dynamic> json) =>
      $AlbumInfoAlbumInfoFromJson(json);
...
class AlbumInfoAlbumInfoCommentThread {
  ...
  factory AlbumInfoAlbumInfoCommentThread.fromJson(Map<String, dynamic> json) =>
      $AlbumInfoAlbumInfoCommentThreadFromJson(json);
...
class AlbumInfoAlbumInfoCommentThreadResourceInfo {
  ...
  factory AlbumInfoAlbumInfoCommentThreadResourceInfo.fromJson(
    Map<String, dynamic> json,
  ) => $AlbumInfoAlbumInfoCommentThreadResourceInfoFromJson(json);

  Map<String, dynamic> toJson() =>
      $AlbumInfoAlbumInfoCommentThreadResourceInfoToJson(this);
