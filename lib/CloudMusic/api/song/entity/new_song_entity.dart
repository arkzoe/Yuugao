...
import 'package:yuugao/CloudMusic/generated/json/new_song_entity.g.dart';
import 'dart:convert';
export 'package:yuugao/CloudMusic/generated/json/new_song_entity.g.dart';
...
class NewSongEntity {
  ...
  factory NewSongEntity.fromJson(Map<String, dynamic> json) =>
      $NewSongEntityFromJson(json);
...
class NewSongData {
  ...
  factory NewSongData.fromJson(Map<String, dynamic> json) =>
      $NewSongDataFromJson(json);
...
class NewSongDataPrivilege {
  ...
  factory NewSongDataPrivilege.fromJson(Map<String, dynamic> json) =>
      $NewSongDataPrivilegeFromJson(json);
...
class NewSongDataPrivilegeFreeTrialPrivilege {
  ...
  factory NewSongDataPrivilegeFreeTrialPrivilege.fromJson(
    Map<String, dynamic> json,
  ) => $NewSongDataPrivilegeFreeTrialPrivilegeFromJson(json);

  Map<String, dynamic> toJson() =>
      $NewSongDataPrivilegeFreeTrialPrivilegeToJson(this);
...
class NewSongDataPrivilegeChargeInfoList {
  ...
  factory NewSongDataPrivilegeChargeInfoList.fromJson(
    Map<String, dynamic> json,
  ) => $NewSongDataPrivilegeChargeInfoListFromJson(json);

  Map<String, dynamic> toJson() =>
      $NewSongDataPrivilegeChargeInfoListToJson(this);
...
class NewSongDataArtists {
  ...
  factory NewSongDataArtists.fromJson(Map<String, dynamic> json) =>
      $NewSongDataArtistsFromJson(json);
...
class NewSongDataHMusic {
  ...
  factory NewSongDataHMusic.fromJson(Map<String, dynamic> json) =>
      $NewSongDataHMusicFromJson(json);
...
class NewSongDataMMusic {
  ...
  factory NewSongDataMMusic.fromJson(Map<String, dynamic> json) =>
      $NewSongDataMMusicFromJson(json);
...
class NewSongDataLMusic {
  ...
  factory NewSongDataLMusic.fromJson(Map<String, dynamic> json) =>
      $NewSongDataLMusicFromJson(json);
...
class NewSongDataAlbum {
  ...
  factory NewSongDataAlbum.fromJson(Map<String, dynamic> json) =>
      $NewSongDataAlbumFromJson(json);
...
class NewSongDataAlbumArtists {
  ...
  factory NewSongDataAlbumArtists.fromJson(Map<String, dynamic> json) =>
      $NewSongDataAlbumArtistsFromJson(json);
...
class NewSongDataAlbumArtist {
  ...
  factory NewSongDataAlbumArtist.fromJson(Map<String, dynamic> json) =>
      $NewSongDataAlbumArtistFromJson(json);
...
class NewSongDataBMusic {
  ...
  factory NewSongDataBMusic.fromJson(Map<String, dynamic> json) =>
      $NewSongDataBMusicFromJson(json);
