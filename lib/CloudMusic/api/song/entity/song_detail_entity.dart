...
import 'package:yuugao/CloudMusic/generated/json/song_detail_entity.g.dart';
import 'dart:convert';
export 'package:yuugao/CloudMusic/generated/json/song_detail_entity.g.dart';
...
class SongDetailEntity {
  ...
  factory SongDetailEntity.fromJson(Map<String, dynamic> json) =>
      $SongDetailEntityFromJson(json);
...
class SongDetailSongs {
  ...
  factory SongDetailSongs.fromJson(Map<String, dynamic> json) =>
      $SongDetailSongsFromJson(json);
...
class SongDetailSongsAr {
  ...
  factory SongDetailSongsAr.fromJson(Map<String, dynamic> json) =>
      $SongDetailSongsArFromJson(json);
...
class SongDetailSongsAl {
  ...
  factory SongDetailSongsAl.fromJson(Map<String, dynamic> json) =>
      $SongDetailSongsAlFromJson(json);
...
class SongDetailSongsH {
  ...
  factory SongDetailSongsH.fromJson(Map<String, dynamic> json) =>
      $SongDetailSongsHFromJson(json);
...
class SongDetailSongsM {
  ...
  factory SongDetailSongsM.fromJson(Map<String, dynamic> json) =>
      $SongDetailSongsMFromJson(json);
...
class SongDetailSongsL {
  ...
  factory SongDetailSongsL.fromJson(Map<String, dynamic> json) =>
      $SongDetailSongsLFromJson(json);
...
class SongDetailSongsSq {
  ...
  factory SongDetailSongsSq.fromJson(Map<String, dynamic> json) =>
      $SongDetailSongsSqFromJson(json);
...
class SongDetailPrivileges {
  ...
  factory SongDetailPrivileges.fromJson(Map<String, dynamic> json) =>
      $SongDetailPrivilegesFromJson(json);
...
class SongDetailPrivilegesFreeTrialPrivilege {
  ...
  factory SongDetailPrivilegesFreeTrialPrivilege.fromJson(
    Map<String, dynamic> json,
  ) => $SongDetailPrivilegesFreeTrialPrivilegeFromJson(json);

  Map<String, dynamic> toJson() =>
      $SongDetailPrivilegesFreeTrialPrivilegeToJson(this);
...
class SongDetailPrivilegesChargeInfoList {
  ...
  factory SongDetailPrivilegesChargeInfoList.fromJson(
    Map<String, dynamic> json,
  ) => $SongDetailPrivilegesChargeInfoListFromJson(json);

  Map<String, dynamic> toJson() =>
      $SongDetailPrivilegesChargeInfoListToJson(this);
