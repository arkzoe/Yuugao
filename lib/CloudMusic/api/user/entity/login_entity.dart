...
import 'package:yuugao/CloudMusic/generated/json/login_entity.g.dart';
import 'dart:convert';
export 'package:yuugao/CloudMusic/generated/json/login_entity.g.dart';
...
class LoginProfileExperts {
  ...
  factory LoginProfileExperts.fromJson(Map<String, dynamic> json) =>
      $LoginProfileExpertsFromJson(json);
...
class LoginBindings {
  ...
  factory LoginBindings.fromJson(Map<String, dynamic> json) =>
      $LoginBindingsFromJson(json);
