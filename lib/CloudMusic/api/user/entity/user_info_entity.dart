...
import 'package:yuugao/CloudMusic/generated/json/user_info_entity.g.dart';
import 'dart:convert';
export 'package:yuugao/CloudMusic/generated/json/user_info_entity.g.dart';
...
class UserInfoAccount {
  ...
  factory UserInfoAccount.fromJson(Map<String, dynamic> json) =>
      $UserInfoAccountFromJson(json);
