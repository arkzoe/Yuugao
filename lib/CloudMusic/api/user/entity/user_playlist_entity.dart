...
import 'package:yuugao/CloudMusic/generated/json/user_playlist_entity.g.dart';
import 'dart:convert';
export 'package:yuugao/CloudMusic/generated/json/user_playlist_entity.g.dart';
...
class UserPlaylistEntity {
  ...
  factory UserPlaylistEntity.fromJson(Map<String, dynamic> json) =>
      $UserPlaylistEntityFromJson(json);
...
class UserPlaylistPlaylist {
  ...
  factory UserPlaylistPlaylist.fromJson(Map<String, dynamic> json) =>
      $UserPlaylistPlaylistFromJson(json);
...
class UserPlaylistPlaylistCreator {
  ...
  factory UserPlaylistPlaylistCreator.fromJson(Map<String, dynamic> json) =>
      $UserPlaylistPlaylistCreatorFromJson(json);
